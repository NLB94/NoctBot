...
const settings = await client.getGuild(message.guild);
  ...
  const correctUsage = `${x_mark}${await client.translate('Correct usage', 'en', language)} : \`${settings.general.prefix}addmoneyrole ${module.exports.help.usage}\``
  ...
  const msg = await client.translate(`${message.member} added $${toAdd} to members's ${support} balance with the <@&${role.id}> role !`, 'en', language)
