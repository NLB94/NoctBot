...
module.exports.run = functions.run = async (client, message, args, settings, userInfo)  => {
    ...
    switch (getSetting) {
        ...
        case "welcome": {
            ...
            message.channel.send({embed: {title: 'Server Settings', description: `${check_mark}Successfully enabled welcome system !Type ${settings.general.utilPrefix}welcome keys for more !`}});
            break;
        }
        case "leave": {
