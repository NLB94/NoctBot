            ...
            if (messageReaction.emoji == tada) {
                ...
                if (message.embeds[0].author.name.includes('🎉🎉Giveaway🎉🎉')) {
                    ...
                    const embed = new MessageEmbed()
                        ...
                        .setAuthor(user.username, user.avatarURL(), `${client.botGuild.utilInviteLink}`)
            ...
            if (message.content !== '') {
                ...
                if (message.content.includes('React to get a category') && emoji !== '❌' && message.content.startsWith(user.tag)) {
                    const embed = new MessageEmbed()
                        ...
                        .setDescription(`My prefix in this server is ***\`${settings.general.utilPrefix}\`*** \nIf you need more informations about commands, type ${settings.general.utilPrefix}help <command>! `);
