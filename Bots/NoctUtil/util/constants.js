  ...
  COMMANDS: {
    ...
    BACKUPS: {
      BACKUP: {
        ...
        example: "u~backup load 1èAdp08Y",
        botPerm: true,
        botPermName: 'ADMINISTRATOR',
        permissions: true,
        onlyServerOwner: false,
    ...
    ECONOMY: {
      ADDMONEY: {
        ...
        example: "u~addmoney bank @Noct 100",
        botPerm: false,
        botPermName: '',
        permissions: true,
        onlyServerOwner: false,
      ...
      ADDMONEYROLE: {
        ...
        example: "u~addmoneyrole cash @everyone 100",
        botPerm: false,
        botPermName: '',
        permissions: true,
        onlyServerOwner: false,
      ...
      REMMONEY: {
        ...
        example: "u~rem-money cash @Noct 100",
        botPerm: false,
        botPermName: '',
        permissions: true,
        onlyServerOwner: false,
      ...
      REMMONEYROLE: {
        ...
        enable: false,
        usage: "[cash | bank] <role> <amount>",
        example: "u~remmoney-role @everyone 4700",
        botPerm: false,
        botPermName: '',
        permissions: true,
        onlyServerOwner: false,
    ...
    GIVEAWAY: {
      GCREATE: {
        ...
        example: "u~gcreate 3 3d Nitro #giveaway-channel",
        botPerm: false,
        botPermName: '',
        permissions: true,
        onlyServerOwner: false,
      ...
      GREROLL: {
        ...
        example: "u~greroll 190736281479101979 3",
        botPerm: false,
        botPermName: '',
        permissions: true,
        onlyServerOwner: false,
    ...
    MODERATION: {
      ADDROLE: {
        ...
        enable: true,
        usage: "@role(s) @user(s)",
        example: "u~addrole @role1 @user1 @user2 @role2",
        botPerm: true,
      ...
      KICK: {
        ...
        enable: true,
        usage: "@user {optional : reason}",
        example: "u~kick @Noct#0000 dm ads",
        botPerm: true,
      ...
      REMROLE: {
        ...
        enable: false,
        usage: "@role(s) @user(s)",
        example: "u~remroles @user1 @role1 @user2",
        botPerm: true,
        botPermName: 'MANAGE_ROLES',
        permissions: true,
        onlyServerOwner: false,
      ...
      TEMPBAN: {
        ...
        example: "u~tempban @Noct#0000 2d Not allowed content",
        botPerm: true,
        botPermName: 'BAN_MEMBERS',
        permissions: true,
        onlyServerOwner: false,
      ...
      UNBAN: {
        ...
        enable: true,
        usage: "<user_id>",
        example: "u~unban 735824367698837555",
        botPerm: true,
        botPermName: 'BAN_MEMBERS',
        permissions: true,
        onlyServerOwner: false,
    ...
    OTHER: {
      ...
      REACT: {
        ...
        example: "u~react 806440609127596032 826870663569997884",
        botPerm: true,
      ...
      REPORT: {
        ...
        enable: true,
        usage: "<report>",
        example: "u~report Ban command have some bugs (...).",
        botPerm: false,
