            ...
            if (messageReaction.emoji == tada) {
                ...
                if (message.embeds[0].author.name.includes('🎉🎉Giveaway🎉🎉')) {
                    ...
                    const embed = new MessageEmbed()
                        ...
                        .setAuthor(user.username, user.avatarURL(), `${client.botGuild.protectInviteLink}`)
            ...
            if (message.content !== '') {
                ...
                if (message.content.includes('React to get a category') && emoji !== '❌' && message.content.startsWith(user.tag)) {
                    const embed = new MessageEmbed()
                        ...
                        .setDescription(`My prefix in this server is ***\`${settings.general.protectPrefix}\`*** \nIf you need more inforamtions about commands, type ${settings.general.protectPrefix}help <command>! `);
                ...
                if (emoji === "↩️" && message.content.includes('Click ↩️ for return to home') && message.content.startsWith(user.tag)) {
                    if (message !== undefined) {
                        ...
                        const embed2 = new MessageEmbed()
                            ...
                            .setTitle("Bot Commands")
                            .setURL(`${client.botGuild.supportInvite}`)
                            .setDescription(`My prefix in this server is ***\`${settings.general.protectPrefix}\`*** \nIf you need more informations about commands, type ${settings.general.protectPrefix}help <command>!`)
                            .setTimestamp()
