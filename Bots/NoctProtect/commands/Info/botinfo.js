...
module.exports.run = functions.run = async (client, message, args, settings, userInfo) => {
    ...
    const language = settings.general.language;
          ...
          .setDescription(`[${language == 'fr' ? 'Ajoute-moi' : 'Add me'}](${client.botGuild.protectInviteLink}) | [${language == 'fr' ? 'Serveur de support' : 'Support server'}](${client.botGuild.supportInvite})`)
          .addFields(
