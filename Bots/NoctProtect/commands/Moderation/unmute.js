...
module.exports.run = functions.run = async (client, message, args, settings, userInfo)  => {
    ...
    if (!user) return message.channel.send({embed: {title: 'Invalid Usage', description: `${arrowRight}Correct usage : \`${settings.general.protectPrefix}${module.exports.help.name} ${module.exports.help.usage}\``}});
