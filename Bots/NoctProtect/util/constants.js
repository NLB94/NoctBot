  ...
  COMMANDS: {
    ...
    BACKUPS: {
      BACKUP: {
        ...
        example: "p~backup load 1èAdp08Y",
        botPerm: true,
        botPermName: 'ADMINISTRATOR',
        permissions: true,
        onlyServerOwner: false,
    ...
    ECONOMY: {
      ADDMONEY: {
        ...
        example: "p~addmoney bank @Noct 100",
        botPerm: false,
        botPermName: '',
        permissions: true,
        onlyServerOwner: false,
      ...
      ADDMONEYROLE: {
        ...
        example: "p~addmoneyrole cash @everyone 100",
        botPerm: false,
        botPermName: '',
        permissions: true,
        onlyServerOwner: false,
      ...
      REMMONEY: {
        ...
        example: "p~rem-money cash @Noct 100",
        botPerm: false,
        botPermName: '',
        permissions: true,
        onlyServerOwner: false,
      ...
      REMMONEYROLE: {
        ...
        enable: false,
        usage: "[cash | bank] <role> <amount>",
        example: "p~remmoney-role @everyone 4700",
        botPerm: false,
        botPermName: '',
        permissions: true,
        onlyServerOwner: false,
    ...
    GIVEAWAY: {
      GCREATE: {
        ...
        example: "p~gcreate 3 3d Nitro #giveaway-channel",
        botPerm: false,
        botPermName: '',
        permissions: true,
        onlyServerOwner: false,
      ...
      GREROLL: {
        ...
        example: "p~greroll 190736281479101979 3",
        botPerm: false,
        botPermName: '',
        permissions: true,
        onlyServerOwner: false,
    ...
    MODERATION: {
      ADDROLE: {
        ...
        enable: true,
        usage: "@role(s) @user(s)",
        example: "p~addrole @role1 @user1 @user2 @role2",
        botPerm: true,
      ...
      KICK: {
        ...
        enable: true,
        usage: "@user {optional : reason}",
        example: "p~kick @Noct#0000 dm ads",
        botPerm: true,
      ...
      REMROLE: {
        ...
        enable: false,
        usage: "@role(s) @user(s)",
        example: "p~remroles @user1 @role1 @user2",
        botPerm: true,
        botPermName: 'MANAGE_ROLES',
        permissions: true,
        onlyServerOwner: false,
      ...
      TEMPBAN: {
        ...
        example: "p~tempban @Noct#0000 2d Not allowed content",
        botPerm: true,
        botPermName: 'BAN_MEMBERS',
        permissions: true,
        onlyServerOwner: false,
      ...
      UNBAN: {
        ...
        enable: true,
        usage: "<user_id>",
        example: "p~unban 735824367698837555",
        botPerm: true,
        botPermName: 'BAN_MEMBERS',
        permissions: true,
        onlyServerOwner: false,
    ...
    OTHER: {
      ...
      POLL: {
        ...
        enable: true,
        usage: '\"poll\" \"Answer(s)\"',
        example: 'p~poll "Do you like Noct ?" "Yes" "No" "Maybe"',
        botPerm: true,
        botPermName: 'MANAGE_MESSAGES',
        permissions: true,
        onlyServerOwner: false,
      ...
      REACT: {
        ...
        example: "p~react 806440609127596032 826870663569997884",
        botPerm: true,
      ...
      REPORT: {
        ...
        enable: true,
        usage: "<report>",
        example: "p~report Ban command have some bugs (...).",
        botPerm: false,
