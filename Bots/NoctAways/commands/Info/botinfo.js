...
module.exports.run = functions.run = async (client, message, args, settings, userInfo) => {
    ...
    const language = settings.general.language;
          ...
          .setURL(`${client.botGuild.giveawayInviteLink}`)
          .setThumbnail(client.user.displayAvatarURL())
          .setDescription(`[${language == 'fr' ? 'Ajoute-moi' : 'Add me'}](${client.botGuild.giveawayInviteLink}) | [${language == 'fr' ? 'Serveur de support' : 'Support server'}](${client.botGuild.supportInvite})`)
          .addFields(
