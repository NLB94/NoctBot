...
module.exports = async (client, message) => {
  ...
  if (!message.content.startsWith(settings.general.ticketPrefix) && userInfo !== undefined) return client.notStartByPrefix(message, settings, userInfo);
  if (message.content.startsWith(settings.general.ticketPrefix)) {
    ...
    if (command.help.args && !args.length) {
      ...
      if (command.help.usage)
        noArgsReply += `\`${settings.general.ticketPrefix}${command.help.name} ${command.help.usage}\``;
      if (command.help.name === `config` || command.help.name == 'level' || command.help.name == 'captcha' || command.help.name == 'ticket' || command.help.name == 'welcome' || command.help.name == 'leave')
        noArgsReply += `\nIf you want to show all available keys, type \`${settings.general.ticketPrefix}${command.help.name} keys\``;
