  ...
  COMMANDS: {
    ...
    BACKUPS: {
      BACKUP: {
        ...
        example: "t~backup load 1èAdp08Y",
        botPerm: true,
        botPermName: 'ADMINISTRATOR',
        permissions: true,
        onlyServerOwner: false,
    ...
    ECONOMY: {
      ADDMONEY: {
        ...
        example: "t~addmoney bank @Noct 100",
        botPerm: false,
        botPermName: '',
        permissions: true,
        onlyServerOwner: false,
      ...
      ADDMONEYROLE: {
        ...
        example: "t~addmoneyrole cash @everyone 100",
        botPerm: false,
        botPermName: '',
        permissions: true,
        onlyServerOwner: false,
      ...
      REMMONEY: {
        ...
        example: "t~rem-money cash @Noct 100",
        botPerm: false,
        botPermName: '',
        permissions: true,
        onlyServerOwner: false,
      ...
      REMMONEYROLE: {
        ...
        enable: false,
        usage: "[cash | bank] <role> <amount>",
        example: "t~remmoney-role @everyone 4700",
        botPerm: false,
        botPermName: '',
        permissions: true,
        onlyServerOwner: false,
    ...
    GIVEAWAY: {
      GCREATE: {
        ...
        example: "t~gcreate 3 3d Nitro #giveaway-channel",
        botPerm: false,
        botPermName: '',
        permissions: true,
        onlyServerOwner: false,
      ...
      GREROLL: {
        ...
        example: "t~greroll 190736281479101979 3",
        botPerm: false,
        botPermName: '',
        permissions: true,
        onlyServerOwner: false,
    ...
    MODERATION: {
      ADDROLE: {
        ...
        enable: true,
        usage: "@role(s) @user(s)",
        example: "t~addrole @role1 @user1 @user2 @role2",
        botPerm: true,
      ...
      KICK: {
        ...
        enable: true,
        usage: "@user {optional : reason}",
        example: "t~kick @Noct#0000 dm ads",
        botPerm: true,
      ...
      REMROLE: {
        ...
        enable: false,
        usage: "@role(s) @user(s)",
        example: "t~remroles @user1 @role1 @user2",
        botPerm: true,
        botPermName: 'MANAGE_ROLES',
        permissions: true,
        onlyServerOwner: false,
      ...
      TEMPBAN: {
        ...
        example: "t~tempban @Noct#0000 2d Not allowed content",
        botPerm: true,
        botPermName: 'BAN_MEMBERS',
        permissions: true,
        onlyServerOwner: false,
      ...
      UNBAN: {
        ...
        enable: true,
        usage: "<user_id>",
        example: "t~unban 735824367698837555",
        botPerm: true,
        botPermName: 'BAN_MEMBERS',
        permissions: true,
        onlyServerOwner: false,
    ...
    OTHER: {
      ...
      REACT: {
        ...
        example: "t~react 806440609127596032 826870663569997884",
        botPerm: true,
      ...
      REPORT: {
        ...
        enable: true,
        usage: "<report>",
        example: "t~report Ban command have some bugs (...).",
        botPerm: false,
